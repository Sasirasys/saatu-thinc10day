...
export default async function Page({
  ...
  return (
    <main className="mt-16 overflow-y-auto">
      <Image src='/katha-BG.png' width={1919} height={2715} alt="" className='absolute top-0 -z-10' />
      <a href='/selection' className='size-[8vw] absolute top-[3vw] left-[3vw]'><Image src='/backButton.png' fill={true} alt="Back button" /></a>
